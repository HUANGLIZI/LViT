...
This repo is the official implementation of "**LViT: Language meets Vision Transformer in Medical Image Segmentation**" Paper Link(https://arxiv.org/abs/2206.14718)
